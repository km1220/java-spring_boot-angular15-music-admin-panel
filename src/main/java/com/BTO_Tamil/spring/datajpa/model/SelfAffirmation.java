...
@Entity
@Table(name = "self_affirmation")
public class SelfAffirmation {
	...
	public SelfAffirmation() {}

	public SelfAffirmation(String song_name,String url, int paid, int offline_download) {
